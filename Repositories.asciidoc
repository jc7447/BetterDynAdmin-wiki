...
.HTML Item view
[caption="Figure 1: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-HTMLRepositoryItemView.png[HTML Item view]
...
.HTML Item view link
[caption="Figure 2: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-AddAndReload.png[HTML Item view link]

[#HtmlViewUpdate]
.HTML Item view update
[caption="Figure 3: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-UpdateItem.png[HTML Item view update]
...
.Query Box
[caption="Figure 4: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-QueryBox.png[Query box]
...
.Stored queries
[caption="Figure 5: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-StoredQueries.png[Store queries]
...
[caption="Figure 6: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-StoredQueries.png[Store Query preview]

== Repository Items properties

.Item properties
[caption="Figure 7: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-RepositoryItemsProperties.png[Items properties]
...
.Repository Items properties
[caption="Figure 8: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-RepositoryItemProperties.png[Repository Item properties]
...
[caption="Figure 9: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-DebugRepositoryItemProperty.png[Debug Repository Item property]
...
[caption="Figure 10: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-ItemTreePossibilities.png[Item tree possibilities]

Here are some sample of what it can do:

.Item tree as HTML tables
[caption="Figure 11: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-ItemTreeHTML.png[Item tree as HTML tables]
...
[caption="Figure 12: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-ItemTreeAddItem.png[Item tree as <add-items>]

.Item Tree as SVG Tree
[caption="Figure 13: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-ItemTree-SVG.png[Item tree as SVG Tree]

== Cache usage

.Cache usage
[caption="Figure 14: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-CacheUsage.png[Cache usage]
...
.Hiding bloc
[caption="Figure 15: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-Hiding.png[Hiding bloc]
...
[caption="Figure 17: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-RepositoryDefinitionXML.png[XML Repository Definition]
...
[caption="Figure 16: "]
image::https://github.com/jc7447/BetterDynAdmin-wiki/raw/master/resources/repository/OrderRepository-RepositoryDefinition.png[Table Repository Definition]
